...
public class main {
    public static ArrayList<Float> sort(String input) {
        ...
        try {
            FileWriter output = new FileWriter("C:/Users/memyt/IdeaProjects/LapTrinhMang/src/file/output.txt");
    ...
    public static void main(String[]ags) throws IOException {
        String input = new String(Files.readAllBytes(Paths.get("C:/Users/memyt/IdeaProjects/LapTrinhMang/src/file/input.txt")));
        sort(input);
    }
}